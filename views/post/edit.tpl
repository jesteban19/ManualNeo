    ...
    <div class="entry">
     ...
     <div class="row">
       <div class="col-md-12">
        <div class="padd">
         <div class="co-form">
           <form class="form-horizontal" id="frm-entrada" action="{$_layoutParams.base_url}post/update" method="post">
             <fieldset>
               <div class="form-group">
                 <label class="control-label col-md-3"  for="titutlo">Titulo</label>
                 <div class="col-md-9">
                   <input type="text" class="form-control" name="titulo" value="{$post.titulo}" maxlength="200" id="titulo">
                 </div>
               </div>
               <div class="form-group">
                 <label class="control-label col-md-3" for="email">Descripci&oacute;n</label>
                 <div class="col-md-9">
                   <input type="text" class="form-control" value="{$post.sub_title}" name="subtitulo" maxlength="200" id="email">
                 </div>
               </div>
                 <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9">
                   <textarea class="form-control" name="contenido" id="contenido" rows="10">{$post.content}</textarea>
                 </div>
               </div>
                <div class="form-group">
                 ...
                 <div class="col-md-9">
                   ...
                   <input type="hidden" name="tags" value="{$post.tags}"  id="hidden-tags" />
                 </div>
               </div>
               <div class="form-group">
