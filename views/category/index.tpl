...
<div class="padd whity content">
  ...
  <h2>Categoria a buscar "{$filtro}"</h2>
  <hr/>
  <div class="posts">
    ...
    <ul class="pager">
      {if $page!=1}
      <li class="previous">
        <a href="{$_layoutParams.base_url}category/index/{$filtro}/{$page-1}">&larr; Atras</a>
      </li>
      {/if}
      
      <li class="next">
        <a href="{$_layoutParams.base_url}category/index/{$filtro}/{$page+1}">Siguiente &rarr;</a>
      </li>
    </ul>
    {else}
      <div class="alert alert-info"><h3> <i class="fa fa-frown-o"></i> Datos vacios</h3> No se encontraron manuales con la categoria seleccionada.</div>
    {/if}
  </div><!-- end posts -->
