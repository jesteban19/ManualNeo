    ...
    var templates = {
        ...
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn btn-default' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-dedent'></i></a>" +
        ...
        "image":       "<li>" +
                           ...
                           " <div class='modal-dialog'>" +
                            "<div class='modal-content'>" +
                               ...
                               "</div>" +
                               "<div class='modal-body'>" +
                                  "<input type='text' class='bootstrap-wysihtml5-insert-image-url form-control input-lg' value='http://'>" +
                               "</div>" +
                               "<div class='modal-footer'>" +
                                   "<a href='#' class='btn btn-default' data-dismiss='modal'>Cancelar</a>" +
                           ...
                           "</div>" +
                            "</div>"+
                           "</div>"+
                           "<a class='btn btn-default' data-wysihtml5-command='insertImage' title='Insert image'><i class='fa fa-camera'></i></a>" +
                       "</li>",
